...
namespace SBContactManager.Migrations
{
    ...
    [Migration("20210929175956_updatecontactmodel")]
            ...
            modelBuilder.Entity("SBContactManager.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactId = 1,
                            CategoryId = 1,
                            DateAdded = new DateTime(2021, 9, 29, 11, 59, 55, 47, DateTimeKind.Local).AddTicks(4384),
                        ...
                        new
                        {
                            ContactId = 2,
                            CategoryId = 2,
                            DateAdded = new DateTime(2021, 9, 29, 11, 59, 55, 52, DateTimeKind.Local).AddTicks(6334),
                        ...
                        new
                        {
                            ContactId = 3,
                            CategoryId = 3,
                            DateAdded = new DateTime(2021, 9, 29, 11, 59, 55, 52, DateTimeKind.Local).AddTicks(6386),
