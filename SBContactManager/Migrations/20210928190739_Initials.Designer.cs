...
namespace SBContactManager.Migrations
{
    ...
    [Migration("20210928190739_Initials")]
            ...
            modelBuilder.Entity("SBContactManager.Models.Contact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactId = 1,
                            CategoryId = 1,
                            DateAdded = new DateTime(2021, 9, 28, 13, 7, 39, 321, DateTimeKind.Local).AddTicks(3242),
                        ...
                        new
                        {
                            ContactId = 2,
                            CategoryId = 2,
                            DateAdded = new DateTime(2021, 9, 28, 13, 7, 39, 326, DateTimeKind.Local).AddTicks(5147),
                        ...
                        new
                        {
                            ContactId = 3,
                            CategoryId = 3,
                            DateAdded = new DateTime(2021, 9, 28, 13, 7, 39, 326, DateTimeKind.Local).AddTicks(5192),
